...
if __name__ == '__main__':
    ...
    z1, z2, pf = solve_analytical(opt_type='non_robust', nwsum=50)
    ...
    opt_type = 'robust_2'
    eta_s = np.linspace(0.035, 0.05, 2)
    ...
    for eta in eta_s:
        ...
        z1, z2, pf, begin_sim, end_sim = solve_nsga_2(popsize=100, n_runs=200, eta=eta, h=h, opt_type='robust_2',
                                                      real_time=True, verbose=False, delta=0.3)
        # comb = np.array([z1, z2])
        # print(comb)
        # print(comb.shape)
