...
if __name__ == '__main__':
    ...
    opt_type = 'robust_2'
    eta_s = np.linspace(0.05, 0.034, 2)
    ...
    for eta in eta_s:
        ...
        # z1, z2, pf, begin_sim, end_sim = solve_nsga_2(popsize=500, n_runs=4000, eta=eta, h=h, opt_type='robust_2',
        #                                               real_time=False, verbose=True, delta=0.28)
        # comb = np.array([z1, z2])
        # print(comb)
        # print(comb.shape)
